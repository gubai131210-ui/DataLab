...
class LifeDataLognormalDialog final : public QDialog {
    Q_OBJECT

public:
    explicit LifeDataLognormalDialog(
        const QStringList& column_labels, QWidget* parent = nullptr);

    datalab::domain::LifeDataLognormalConfiguration configuration() const;
...
private:
    ...
    QComboBox* event_combo_ = nullptr;
    QListWidget* covariate_list_ = nullptr;
    QPlainTextEdit* options_note_ = nullptr;
