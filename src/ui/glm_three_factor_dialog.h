...
class GlmThreeFactorDialog final : public QDialog {
    Q_OBJECT

public:
    explicit GlmThreeFactorDialog(
        const QStringList& column_labels, QWidget* parent = nullptr);

    datalab::domain::GlmThreeFactorConfiguration configuration() const;
...
private:
    ...
    QComboBox* factor_c_combo_ = nullptr;
    QCheckBox* ab_check_ = nullptr;
    QCheckBox* ac_check_ = nullptr;
    QCheckBox* bc_check_ = nullptr;
