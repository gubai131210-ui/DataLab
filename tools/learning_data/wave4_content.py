...
WAVE4_DATASETS: dict[str, dict] = {
    "graph_hist_prob": {
        ...
        "row_count": 60,
        "notes": "埋点：行48–50 轻微右尾偏高（约+3μm）；全列无片41/55 失控尖峰。期望直方图单峰、概率图大致贴线；不等于已经证明正态/过程合格。",
        "columns": [
    ...
    "graph_density_unimodal": {
        ...
        "row_count": 55,
        "notes": "埋点：行1–55 单峰集中约100μm；约行40–42 略抬高形成肩部。期望密度峰清晰；不等于已经证明正态。",
        "columns": [
    ...
    "graph_ecdf_unimodal": {
        ...
        "story": "单峰厚度供 ECDF 课。",
        "row_count": 50,
        "notes": "埋点：行45–50 上分位抬高；ECDF 后段变陡。不等于放行样板；通常还要对照规程。",
        "columns": [
    ...
    "graph_violin_groups": {
        ...
        "row_count": 48,
        "notes": "埋点：线别=B 行（约行25–48）散度更大。期望小提琴宽度差；不等于放行样板；通常还要对照规程。",
        "columns": [
            {"index": 0, "name": "厚度_um", "role_hint": "measurement", "unit": "μm", "description": "Y"},
            {"index": 1, "name": "线别", "role_hint": "group", "description": "A/B"},
    ...
    "graph_bar_category": {
        ...
        "story": "缺陷类别频次；虚焊主导。",
        "row_count": 80,
        "notes": "埋点：全表约80行配方中虚焊约占一半（对照行1起任意抽样可见最高频类）；期望条形最高。不等于放行样板；通常还要对照规程。",
        "columns": [
    ...
    "graph_pie_category": {
        ...
        "story": "类别份额；虚焊最大片。",
        "row_count": 70,
        "notes": "埋点：虚焊约 40%+；期望饼图最大扇区。不等于放行样板；通常还要对照规程。",
        "columns": [
            {"index": 0, "name": "缺陷类别", "role_hint": "category", "description": "类别"},
    ...
    "graph_eda4_series": {
        ...
        "row_count": 48,
        "notes": "埋点：行25–36 均值抬高约 +1.2。期望 run/lag 等面板显示非随机。不等于已经证明正态。",
        "columns": [
    ...
    "doe_opt_two_resp": {
        ...
        "story": "两因子两响应；目标冲突弱。",
        "row_count": 32,
        "notes": "埋点：温度高时 Y1 升、Y2 略降；2×2×8 重复=32 行。期望优化折中区。不等于放行样板；通常还要对照规程。",
        "columns": [
            {"index": 0, "name": "温度", "role_hint": "factor", "description": "±1"},
            {"index": 1, "name": "压力", "role_hint": "factor", "description": "±1"},
    ...
    "ts_smooth_weekly": {
        ...
        "row_count": 40,
        "notes": "埋点：行1–40 含噪声上升趋势；期望指数平滑轨迹比原始更顺。不等于放行样板；通常还要对照规程。",
        "columns": [
    ...
    *,
    ...
    return {
        ...
        "click_steps": [
            ...
            "读输出时把结论停在看见了什么；不等于已经放行、必须立刻停线、已经证明正态或量具通过。",
        ],
...
def build_data_overlays() -> dict[str, dict]:
    ...
    out["histogram"] = _data_overlay(
        title="直方图",
        used_for="看单变量形状/峰度/偏态线索。可与概率图对照同一张厚度练习表。",
        not_for="替代控制图；规格符合性。不等于已经证明正态。不要把本课表硬套到密度图或经验累积分布图课。",
        ...
        click_steps=[
            ...
            "对照行48–50 右尾肩部；不等于已经证明正态；不等于放行样板；通常还要对照规程。",
        ],
        detail=[
        ...
        output_guide=[{"name": "直方图", "meaning": "指着右尾肩部。不等于已经证明正态。"}],
        ...
        retrieval=["共享族？", "行48？", "红线习惯"],
        misc=[{"wrong": "直方图贴正态曲线=已证明正态", "right": "不等于已经证明正态。"}],
    )

    out["probability_plot"] = _data_overlay(
        title="正态概率图",
        used_for="用概率图看点是否大致贴参考线。与直方图同构共享 graph_hist_prob。",
        not_for="替代正式正态性检验结论；不等于已经证明正态。",
        ...
        buried=[{"row": 48, "what": "右尾三点", "expect": "概率图高端偏离参考线；不等于已经证明正态。"}],
        output_guide=[{"name": "概率图", "meaning": "指着高端偏离。不等于已经证明正态。"}],
        ...
        fade_ds="graph_hist_prob",
        retrieval=["role id？", "行48？", "红线习惯"],
        misc=[{"wrong": "概率图通过=已证明正态", "right": "不等于已经证明正态。"}],
    )
    ...
    specs = [
        (
            ...
            [{"row": 40, "what": "行40–42 肩部", "expect": "密度峰右肩；不等于已经证明正态。"}],
            "图形 → 密度图",
            "variable=`厚度_um`",
        ),
        (
            ...
            _g3(("ECDF", "经验累积分布。", "看分位。"), ("上分位", "高端抬高。", "行45–50。"), ("红线习惯", "不等于放行样板。", "探索图。")),
            [{"row": 45, "what": "上分位抬高", "expect": "ECDF 后段变陡；不等于放行样板；通常还要对照规程。"}],
            "图形 → 经验累积分布图",
            "variable=`厚度_um`",
        ),
        (
        ...
        (
            ...
            _g3(("小提琴图", "密度+箱线信息。", "看形状宽度。"), ("宽度", "局部密度。", "B更宽。"), ("红线习惯", "不等于放行样板。", "探索。")),
            [{"row": 25, "what": "B组散度更大", "expect": "小提琴更宽；不等于放行样板；通常还要对照规程。"}],
            "图形 → 小提琴图",
            "变量=`厚度_um`；分类=`线别`",
        ),
        (
            ...
            [{"row": 31, "what": "腔3均值偏低", "expect": "区间位置差；不等于放行样板。"}],
            "图形 → 区间图",
            "响应=`厚度_um`；类别=`腔号`",
        ),
        (
            ...
            _g3(("条形图", "类别频数/数值。", "探索帕累托前奏。"), ("虚焊", "最高条。", "配方埋点。"), ("红线习惯", "不等于放行样板。", "图≠放行。")),
            [{"row": 1, "what": "虚焊频次最高（全表配方）", "expect": "最高条为虚焊；不等于放行样板；通常还要对照规程。"}],
            "图形 → 条形图",
            "类别=`缺陷类别`",
        ),
        (
            ...
            _g3(("饼图", "份额扇区。", "类别占比。"), ("最大扇区", "虚焊。", "埋点。"), ("红线习惯", "不等于放行样板。", "探索。")),
            [{"row": 1, "what": "虚焊份额最大", "expect": "最大扇区；不等于放行样板；通常还要对照规程。"}],
            "图形 → 饼图",
            "分类=`缺陷类别`",
        ),
        (
            ...
            [{"row": 1, "what": "晚班×虚焊占比抬高", "expect": "对应格面积大；不等于放行样板。"}],
            "图形 → 马赛克图",
            "分类列多选 `班次` 与 `缺陷类别`",
        ),
        (
            ...
            [{"row": 42, "what": "偏移尖峰离群", "expect": "点远离主云；不等于放行样板；通常还要对照规程。"}],
            "图形 → 散点图",
            "X=`温度_C`；Y=`偏移_um`",
        ),
        (
            ...
            [{"row": 1, "what": "中心密度核", "expect": "中心 hex 更深；不等于放行样板；通常还要对照规程。"}],
            "图形 → Hexbin",
            "X=`X坐标`；Y=`Y坐标`",
        ),
        (
            ...
            _g3(("气泡图", "第三维用尺寸。", "XYZ 编码。"), ("大气泡", "行30–36。", "埋点。"), ("红线习惯", "不等于放行样板。", "探索。")),
            [{"row": 30, "what": "尺寸显著更大", "expect": "大气泡可见；不等于放行样板；通常还要对照规程。"}],
            "图形 → 气泡图",
            "X/Y/尺寸三列",
        ),
        (
            ...
            _g3(("边际图", "散点+边缘分布。", "联合与边际。"), ("正相关", "主云斜向。", "埋点。"), ("红线习惯", "勿已证明正态。", "边缘像≠证明。")),
            [{"row": 1, "what": "正相关云", "expect": "斜向点云+单峰边际；不等于已经证明正态。"}],
            "图形 → 边际图",
            "X=`X值`；Y=`Y值`",
        ),
        (
            ...
            _g3(("等值线", "Z 的等高线。", "看峰谷。"), ("中心峰", "X≈0,Y≈0。", "埋点。"), ("红线习惯", "不等于放行样板。", "响应面探索。")),
            [{"row": 28, "what": "中心附近 Z 高", "expect": "中心等值峰；不等于放行样板；通常还要对照规程。"}],
            "图形 → 等值线图",
            "X/Y/Z 三列",
        ),
        (
            ...
            [{"row": 1, "what": "A–B 强相关结构", "expect": "对应色块更深；不等于放行样板；通常还要对照规程。"}],
            "图形 → 相关图",
            "多选三变量",
        ),
        (
            ...
            _g3(("热图", "矩阵着色。", "看块结构。"), ("A-B块", "更亮/更深。", "埋点。"), ("红线习惯", "不等于放行样板。", "探索。")),
            [{"row": 1, "what": "A–B 高相关块", "expect": "热图对应块突出；不等于放行样板；通常还要对照规程。"}],
            "图形 → 热图",
            "多选三变量",
        ),
        (
            ...
            [{"row": 1, "what": "厚度-偏移正斜率", "expect": "对应面板相关；不等于放行样板；通常还要对照规程。"}],
            "图形 → 矩阵图",
            "多选三列",
        ),
        (
            ...
            _g3(("平行坐标", "多维折线。", "看簇。"), ("差品", "行21–30 后两轴低。", "埋点。"), ("红线习惯", "不等于放行样板。", "探索。")),
            [{"row": 21, "what": "差品后两轴偏低", "expect": "折线在轴3/4 下沉；不等于放行样板；通常还要对照规程。"}],
            "图形 → 平行坐标图",
            "多选轴1–轴4",
        ),
        (
            ...
            _g3(("区域图", "时间-数值填色。", "看台阶。"), ("后段台阶", "周≥25。", "行25起。"), ("红线习惯", "不等于放行样板。", "趋势探索。")),
            [{"row": 25, "what": "产量台阶抬高", "expect": "面积后段抬升；不等于放行样板；通常还要对照规程。"}],
            "图形 → 区域图",
            "时间=`周次`；数值=`产量`",
        ),
        (
            ...
            _g3(("EDA 四图", "run/lag/hist/norm 面板。", "NIST 风格。"), ("中段漂移", "行25–36。", "埋点。"), ("红线习惯", "勿已证明正态。", "诊断线索。")),
            [{"row": 25, "what": "中段均值抬高", "expect": "run/lag 非随机线索；不等于已经证明正态。"}],
            "图形 → EDA 四图",
            "变量=`厚度_um`",
        ),
        (
            ...
            [{"row": 35, "what": "第三方向离群", "expect": "得分/载荷异常线索；不等于放行样板；通常还要对照规程。"}],
            "统计 → 主成分分析",
            "多选三指标；mode 用目录默认",
        ),
        (
            ...
            _g3(("析因响应", "估主效应/交互。", "温度主效应。"), ("编码±1", "设计单位。", "本表。"), ("红线习惯", "不等于放行样板。", "效应≠放行。")),
            [{"row": 1, "what": "温度=+1 响应抬高（全表结构）", "expect": "温度主效应明显；不等于放行样板；通常还要对照规程。"}],
            "统计 → DOE 响应分析",
            "响应=`响应Y`；因子列=`温度`,`压力`",
        ),
        (
            ...
            _g3(("响应优化", "多响应折中。", "期望面。"), ("冲突", "Y1↑时 Y2 略变。", "埋点。"), ("红线习惯", "不等于放行样板。", "优化≠放行。")),
            [{"row": 1, "what": "温度高 Y1 升、Y2 略降", "expect": "折中区；不等于放行样板；通常还要对照规程。"}],
            "统计 → DOE 响应优化",
            "两响应+两因子",
        ),
        (
            ...
            [{"row": 1, "what": "顶点/边/内部共30行（行1–3顶点）", "expect": "点落在三角形；不等于放行样板；通常还要对照规程。"}],
            "图形 → 混料三角图",
            "三组分列",
        ),
        (
            ...
            _g3(("保修摘要", "窗口内风险摘要。", "输入驱动。"), ("暴露列", "优先于标量。", "本课。"), ("红线习惯", "不等于放行样板。", "摘要≠放行。")),
            [{"row": 1, "what": "暴露量列可求和", "expect": "用列暴露而非只靠标量；不等于放行样板；通常还要对照规程。"}],
            "统计 → 保修摘要",
        ...
        (
            ...
            [{"row": 30, "what": "产量后段抬高", "expect": "曲线后段上移；不等于放行样板；通常还要对照规程。"}],
            "图形 → 时间序列图",
            "时间=`周次`；数值=`产量`",
        ),
        (
            ...
            _g3(("分解", "趋势+季节+残差。", "period=4。"), ("季节", "周期分量。", "埋点。"), ("红线习惯", "不等于放行样板。", "分解≠放行。")),
            [{"row": 1, "what": "季节周期4+上趋势", "expect": "季节分量周期≈4；不等于放行样板；通常还要对照规程。"}],
            "统计 → 时间序列分解",
            "时间=`周次`；值=`产量`；period=4",
        ),
        (
            ...
            [{"row": 1, "what": "噪声上升趋势", "expect": "平滑曲线更顺；不等于放行样板；通常还要对照规程。"}],
            "统计 → 时间序列平滑",
            "序列=`产量`；alpha≈0.2",
        ),
    ]
    ...
    for cid, title, ds, fill, detail, gloss, buried, menu, fill_hint in specs:
        out[cid] = _data_overlay(
            ...
            not_for="替代推断或放行结论。图画完不等于放行样板，也不等于已经证明正态；停线通常还要对照规程。",
            ...
            click_steps=[
                ...
                f"菜单：{menu}。",
                f"按角色映射：{fill_hint}。",
                "对照埋点读图；现场口语可以停在「看见了什么」；放行/停线通常还要对照规程。",
            ],
            detail=detail,
            glossary=gloss,
            buried=buried,
            output_guide=[{"name": title, "meaning": "对照埋点读出看见了什么；不等于放行样板，通常还要对照规程。"}],
            mission=f"能独立导入 `demo_{ds}` 完成「{title}」并拒绝红线习惯。",
            prereq=[
                {"q": "dataset？", "good": ds, "bad": "旧10表"},
                {"q": "能不能直接写成放行？", "good": "通常还不写到放行", "bad": "可以写成放行"},
            ...
            fade_ds=ds,
            retrieval=["dataset_id？", "埋点行？", "红线习惯"],
            misc=[{"wrong": "图画完就等于可以放行", "right": "不等于放行样板；通常还要对照规程。"}],
        )
...
def build_empty_overlays(wave4_ids: list[str], data_ids: set[str]) -> dict[str, dict]:
    ...
    for cid in wave4_ids:
        ...
        out[cid] = _formula_skeleton(
            ...
            not_for="本波不提供演示表；勿把旧共享表硬挂过来。不等于放行样板；通常还要对照规程。",
            ...
            retrieval=["dataset？", "menu_path？", "红线习惯"],
...
def write_overlays() -> None:
    ...
    overlays = {
        cid: apply_warmth(cid, polish_overlay(cid, payload))
